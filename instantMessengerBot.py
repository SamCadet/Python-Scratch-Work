...
# instantMessengerBot.py - automate message for friends list

import time
import pyautogui


# Answer - https://github.com/IFinners/automate-the-boring-stuff-projects/blob/master/Chapter%2018/im_bot.py
