...
# filling_gaps.py - Copies an entire folder and its contents into
...
# https://github.com/IFinners/automate-the-boring-stuff-projects/blob/master/Chapter%2009/filling_gaps.py
